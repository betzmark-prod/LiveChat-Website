        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 text-balance mb-8 max-w-2xl mx-auto lg:mx-0">
              The embeddable AI chat widget that answers customer questions
              instantly and seamlessly escalates to human agents when needed.
